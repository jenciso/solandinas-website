...
<head>
	...
	<title>Soldier - Soldadoras Andinas</title>
...
<body>
	...
	<main>
		<section id="bannersoldier" class="center"></section>
			...
			<article class="center">
				<div id="wrapper">
					<div class="regular slider">
						<div class="prod">
							<a href="soldier-details.php?id=113#details">
								<div class="content">
									<h3>rx-200</h3>
								</div>
								<div class="img">
									<img src="../img/productos/proceso-stick/rx-200.png">
									<o>leer más</o>
								</div>
							</a>
						</div>
