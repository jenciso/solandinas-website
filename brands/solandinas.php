...
<head>
	...
	<title>Solandinas - Soldadoras Andinas</title>
...
<body>
	...
	<main>
		<section id="bannersolandinas" class="center"></section>
			...
			<article class="center">
				<div id="wrapper">
					<div class="regular slider">
						<?
						$sqlstr="select * from saprocesomig order by codigo asc";
						$filas = mysqli_query($conexion, $sqlstr);
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
								<a href="../products/proceso-mig.php?id=<?echo$fila['codigo'];?>#details">
									<div class="content">
										<h3><?echo$fila['namereco'];?></h3>
									</div>
									<div class="img">
										<img src="../img/productos/proceso-mig/<?echo$fila['img'];?>.png">
										<o>leer más</o>
									</div>
								</a>
							</div>
						<? }?>
						<?
						$sqlstr="select * from sacargadores order by codigo asc";
						$filas = mysqli_query($conexion, $sqlstr);
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
								<a href="../products/cargadores.php?id=<?echo$fila['codigo'];?>#details">
									<div class="content">
										<h3><?echo$fila['namereco'];?></h3>
									</div>
									<div class="img">
										<img src="../img/productos/cargadores/<?echo$fila['img'];?>.png">
										<o>leer más</o>
									</div>
								</a>
							</div>
						<? }?>
						<?
						$sqlstr="select * from saalimentadores order by codigo asc";
						$filas = mysqli_query($conexion, $sqlstr);
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
						...
						<? }?>
						<?
						$sqlstr="select * from samultiproceso order by codigo asc";
						$filas = mysqli_query($conexion, $sqlstr);
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
								<a href="../products/multiproceso.php?id=<?echo$fila['codigo'];?>#details">
									<div class="content">
										<h3><?echo$fila['namereco'];?></h3>
									</div>
									<div class="img">
										<img src="../img/productos/multiproceso/<?echo$fila['img'];?>.png">
										<o>leer más</o>
									</div>
								</a>
							</div>
						<? }?>
						<?
						$sqlstr="select * from saprocesostick order by codigo asc limit 13";
						$filas = mysqli_query($conexion, $sqlstr);
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
								<a href="../products/proceso-stick.php?id=<?echo$fila['codigo'];?>#details">
									<div class="content">
										<h3><?echo$fila['namereco'];?></h3>
									</div>
									<div class="img">
						...
						<? }?>
						<!--<div class="prod">
							<a href="../products/proceso-stick.php?id=115#details">
								<div class="content">
									<h3>ri-200</h3>
								</div>
								<div class="img">
									<img src="../img/productos/proceso-stick/ri-200.png">
									<o>leer más</o>
								</div>
							</a>
						</div>-->
						<?$sqlstr="select * from saprocesotig order by codigo asc limit 3";
						$filas = mysqli_query($conexion, $sqlstr);
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
								<a href="../products/proceso-tig.php?id=<?echo$fila['codigo'];?>#details">
									<div class="content">
										<h3><?echo$fila['namereco'];?></h3>
									</div>
									<div class="img">
										<img src="../img/productos/proceso-tig/<?echo$fila['img'];?>.png">
										<o>leer más</o>
									</div>
								</a>
							</div>
