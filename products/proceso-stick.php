					...
					<div id="wrapper">
					    <div class="columns">
    						...
    						<div class="text">
    							...
    							<?echo$fila['descrip'];?>
    							<div id="tablas"><img src="tablas/stick/<?echo$fila['modulos']?>.png" class="tablas"></div>
					    ...
					    <div class="center btn-fichatecnica"><a href="pdfs/stick/<?echo$fila['img'];?>.pdf" target="_blank" class="btn-ficha">ver ficha técnica</a></div>
					</div>
				<? }?>
			</article>
		</section>
