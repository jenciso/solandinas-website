...
<head>
	...
	<?$id = $_REQUEST["id"];
	$sqlstr="select * from saprocesomig where codigo=".$id;
	$filas = mysqli_query($conexion, $sqlstr);
	while ($fila = mysqli_fetch_array($filas)){?>
	<?$id=$fila['codigo'];?>
		<title><?echo$fila['name'];?> - Proceso Mig - Soldadoras Andinas</title>
	<? }?>
			...
			<article class="center">
				...
				while ($fila = mysqli_fetch_array($filas)){?>
					<div id="wrapper">
					    <div class="columns">
    						<?$id=$fila['codigo'];?>
    						<div class="img"><img src="../img/productos/proceso-mig/<?echo$fila['img'];?>.png"></div>
    						<div class="text">
    							<h1><?echo$fila['name'];?></h1>
    							<?echo$fila['descrip'];?>
    							<div id="tablas"><img src="tablas/mig/<?echo$fila['modulos']?>.png" class="tablas tablas-mig"></div>
    							<!--<img src="tablas/mig/<?echo$fila['table-one'];?>.png" class="tablas">-->
        					</div>
    				    </div>
					    <!--<div class="center"><img src="tablas/mig/<?echo$fila['table-two'];?>.png" class="tablas  tabla-inferior"></div>-->
					    <div class="center btn-fichatecnica"><a href="pdfs/mig/<?echo$fila['img'];?>.pdf" target="_blank" class="btn-ficha">ver ficha técnica</a></div>
					</div>
				<? }?>
			</article>
		</section>
				...
				<div id="wrapper">
					<div class="regular slider">
						...
						while ($fila = mysqli_fetch_array($filas)){?>
							<div class="prod">
								<?$id=$fila['codigo'];?>
								<a href="proceso-mig.php?id=<?echo$fila['codigo'];?>#details">
									<div class="content">
